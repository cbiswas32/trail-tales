...
export function RotatingImageWheel({
    ...
    return (
        ...
        >
            ...
            >
                <div className="pointer-events-none absolute left-1/2 top-2/5 z-20 flex w-[28%] -translate-x-1/2 -translate-y-1/2 flex-col items-center text-center">
                <span className="mb-3 text-xs font-medium uppercase tracking-[0.3em] text-paper/50">
                    Everything in one place
                </span>

                <h2 className="text-balance text-4xl font-handwritten leading-[0.95] tracking-tight text-paper md:text-6xl">
                    Your memories.
                    <br />
                    Every format.
                </h2>

                <p className="mt-5 max-w-md text-sm leading-6 text-paper/55 md:text-base">
                    Photos, Instagram posts, Reels, Facebook memories,
                    YouTube Shorts and everything in between.
                </p>

                <div className="mt-7 rounded-full border border-paper/15 bg-paper/5 px-5 py-2 text-xs uppercase tracking-widest text-paper/70 backdrop-blur-md">
                    Built for the way you share
                </div>
            </div>
